export const policyPages = [
  {
    ...
    paragraphs: [
      ...
      "The contact section links to fran@heroesofmedicine.org using your email application. If you choose to send an email, your email address, message content, and any information you include will be handled through the email providers involved and used by Heroes of Medicine Foundation to review and respond to your message.",
      ...
      "This site links to third-party services, including Amazon. Those services are not controlled by Heroes of Medicine Foundation and have their own privacy practices, terms, and policies.",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "The website includes links to third-party services, including Amazon. Heroes of Medicine Foundation does not control those third-party services and is not responsible for their content, availability, privacy practices, or terms.",
